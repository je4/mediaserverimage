module go.ub.unibas.ch/mediaserver/mediaserverimage/v2
...
require (
	...
	github.com/je4/filesystem/v3 v3.0.17
	...
	go.ub.unibas.ch/mediaserver/mediaserveraction/v2 v2.0.21
	go.ub.unibas.ch/mediaserver/mediaserverproto/v2 v2.0.47
...
require (
	...
	go.ub.unibas.ch/mediaserver/mediaserverhelper/v2 v2.0.0-20241016152753-c226df74c1d0 // indirect
