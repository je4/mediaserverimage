...
func main() {
	...
	srv, err := service.NewActionService(actionDispatcherClients, conf.Instance, conf.Domains, conf.Concurrency, conf.QueueSize, time.Duration(conf.ResolverNotFoundTimeout), vfs, dbClients, logger)
	if err != nil {
